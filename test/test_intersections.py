...
class IntersectionMethods(unittest.TestCase):
    ...
    def test_cubic_line(self):
        q = CubicBezier(Point(100, 240), Point(30, 60), Point(210, 230), Point(160, 30))
    ...
    def test_cubic_cubic(self):
        ...
        q1 = CubicBezier(Point(10, 100), Point(90, 30), Point(40, 140), Point(220, 220))
        q2 = CubicBezier(Point(5, 150), Point(180, 20), Point(80, 250), Point(210, 190))
    ...
    def test_cubic_line_4(self):
        seg = CubicBezier.fromRepr(
            "B<<315.0,296.0>-<404.0,296.0>-<468.0,251.0>-<468.0,183.0>>"
        )
